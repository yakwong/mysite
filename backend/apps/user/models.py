...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    backup_email = models.EmailField(null=True, blank=True, verbose_name="备用邮箱")
    description = models.CharField(max_length=255, unique=False, default=None, null=True, blank=True, verbose_name="简介")
    password_strength = models.CharField(max_length=16, default="unknown", verbose_name="密码强度")
    password_updated_at = models.DateTimeField(null=True, blank=True, verbose_name="密码最后更新时间")
    security_question = models.CharField(max_length=255, null=True, blank=True, verbose_name="密保问题")
    security_answer_hash = models.CharField(max_length=255, null=True, blank=True, verbose_name="密保答案哈希")
    security_question_updated_at = models.DateTimeField(null=True, blank=True, verbose_name="密保更新时间")
    two_factor_enabled = models.BooleanField(default=False, verbose_name="是否开启两步验证")
    login_notifier_enabled = models.BooleanField(default=True, verbose_name="登录提醒开关")
